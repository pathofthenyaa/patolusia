const CACHE="mini-gry-v2.3";const ASSETS=["./","./index.html","./css/app.css","./js/app.js","./games/sudoku.html","./games/battleships.html","./games/go.html","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
