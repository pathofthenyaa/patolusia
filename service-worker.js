const CACHE="mini-gry-v2.2";
const ASSETS=["./","./index.html","./css/app.css","./js/app.js","./games/sudoku.html","./games/battleships.html","./games/go.html","./games/minesweeper.html","./games/memory.html","./games/lights-out.html","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
